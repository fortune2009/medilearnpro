...
class _ProfileState extends State<Profile> with TickerProviderStateMixin {
  ...
  Widget _buildScreen(BuildContext context, ProfileViewModel viewModel) {
    return Scaffold(
      appBar: buildAppbar(
          context: context, hasLeading: true, title: Styles.medium("Profile")),
                    ...
                    child: Column(
                      ...
                      children: [
                        Styles.regular("Full Name",
                            fontSize: 12.sp, color: AppColors.blackText),
                        HSpace(13.h),
                        Styles.medium(viewModel.userData!.displayName ?? "",
                            fontSize: 14.sp, color: AppColors.blackText),
                      ],
                    ),
                  ),
                  HSpace(22.h),
