                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Styles.regular(
                                  "Have access to free online lessons across our multi-dimensional article",
                                  color: AppColors.black,
                                  fontSize: 14.sp,
                                ),
                              ),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.symmetric(horizontal: 20.w),
                                    child: Styles.regular(
                                      "Elevate Your Medical Expertise with Our Cutting-Edge E-Learning Medic App. Learn, Master, Excel",
                                      color: AppColors.black,
                                      fontSize: 14.sp,
                                    ),
                                  ),
                            ...
                            : Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text.rich(TextSpan(children: [
                                      Styles.spanRegular(
                                        "Stay Informed with your Medical ",
                                        color: AppColors.black,
                                        fontSize: 36.sp,
                                        fontWeight: FontWeight.w700,
                                      ),
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.symmetric(horizontal: 20.w),
                                    child: Styles.regular(
                                      "Stay Informed, Elevate Your Medical Expertise with Our Dynamic E-Learning Medic App and Live Feeds",
                                      color: AppColors.black,
                                      fontSize: 14.sp,
                                    ),
                                  ),
